"""Remove baked white padding from Kickora launcher master icon."""
...
SRC = ROOT / "assets" / "branding" / "final" / "app_icon_1024.png"
OUT = SRC
CANVAS = 1024
FILL_RATIO = 0.90
...
def is_outer_background(r: int, g: int, b: int, a: int = 255) -> bool:
    if a == 0:
        return True
...
def main() -> None:
    ...
    print(f"Saved transparent launcher icon to {OUT}")
