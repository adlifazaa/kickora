...
Flutter football app (`com.sugarkeys.kickora`). **Mock data is the default** for Play Store and everyday development — no API keys in the repo or release binaries.
