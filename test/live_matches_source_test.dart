...
import 'package:kickora/data/sources/live_matches_source.dart';
import 'package:kickora/data/models/match_model.dart';

void main() {
  test('LiveMatchesSource is inactive in default mock mode', () {
    expect(ApiConstants.apiMode, ApiMode.mock);
    expect(LiveMatchesSource.isRemoteLiveActive, isFalse);
  });
